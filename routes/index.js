...
router.post('/registerbook', function (req, res, next) {
  ...
  x.push(req.body);
  WriteBooks(x);
  res.redirect('/booklibrary');
  
});

/* GET booklibrary page.---------------------------------------------------- */
router.get('/booklibrary', function (req, res, next) {
...
/* GET updatebook page .----------------------------------------------------- */
router.get('/updatebook/:index', function (req, res, next) {
  const books = Books();
...
router.post("/updatebook/:index", function (req, res, next) {
  let x = Books();
